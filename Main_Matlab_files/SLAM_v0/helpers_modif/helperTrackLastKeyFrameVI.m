...
function [currPose, mapPointIdx, featureIdx, trackingLost] = helperTrackLastKeyFrameVI(...
...
% If no points have been matched, set the Tracking Lost flag
if isempty(matchedImagePoints)
...
% Si le tracking est perdu, on retourne "trackingLost"
if status
    currPose=rigidtform3d();
    mapPointIdx=[];
    featureIdx=[];
